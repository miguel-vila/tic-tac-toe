...
h.call = function() {
  ...
  var H = null, H = function(H, ca, ha, ka, ma, sa, ya, Da, Ga, Ma, Va, db, ob, zb, Mb, hc, xc, Zc, Md, Le, pg, ai) {
    switch(arguments.length) {
      case 1:
      ...
      case 19:
        return d.call(this, H, ca, ha, ka, ma, sa, ya, Da, Ga, Ma, Va, db, ob, zb, Mb, hc, xc, Zc, Md);
      case 20:
        return c.call(this, H, ca, ha, ka, ma, sa, ya, Da, Ga, Ma, Va, db, ob, zb, Mb, hc, xc, Zc, Md, Le);
      case 21:
        return b.call(this, H, ca, ha, ka, ma, sa, ya, Da, Ga, Ma, Va, db, ob, zb, Mb, hc, xc, Zc, Md, Le, pg);
      case 22:
        return a.call(this, H, ca, ha, ka, ma, sa, ya, Da, Ga, Ma, Va, db, ob, zb, Mb, hc, xc, Zc, Md, Le, pg, ai);
    }
    throw Error("Invalid arity: " + arguments.length);
  };
  H.d = Ha;
...
var Pd = function() {
  ...
  function c(a, b) {
    var c;
    a instanceof Id ? (c = a.state, c = b.d ? b.d(c) : b.call(null, c), c = Nd(a, c)) : c = Ob.c(a, b);
    return c;
  }
  var d = null, e = function() {
    function a(c, d, e, f, p) {
    ...
    function b(a, c, d, e, f) {
      return a instanceof Id ? Nd(a, V.A(c, a.state, d, e, f)) : Ob.A(a, c, d, e, f);
    }
    a.r = 4;
    a.m = function(a) {
      var c = K(a);
...
"pass", "om.core/pass", -1453289268), mg = new W(null, "recur", "recur", -437573268), ng = new W(null, "init-state", "init-state", 1450863212), og = new W(null, "catch-block", "catch-block", 1175212748), qg = new W(null, "state", "state", -1988618099), ra = new W(null, "flush-on-newline", "flush-on-newline", -151457939), rg = new W(null, "componentWillUnmount", "componentWillUnmount", 1573788814), sg = new W(null, "componentWillReceiveProps", "componentWillReceiveProps", 559988974), tg = new W(null, 
...
var Yg = new WebSocket("ws://tic-tac-toe-scala-cljs.herokuapp.com/websockets/user");
var Zg;
function $g(a, b, c) {
  if (a ? a.Ib : a) {
    return a.Ib(0, b, c);
...
var fh, hh = function gh(b) {
  "undefined" === typeof fh && (fh = function(b, d, e) {
    ...
    this.t = 0;
    this.k = 393216;
  }, fh.prototype.bc = function() {
    return!0;
  }, fh.prototype.cc = function() {
    return this.la;
  }, fh.prototype.C = function() {
    return this.Xc;
  }, fh.prototype.G = function(b, d) {
    return new fh(this.la, this.Jb, d);
  }, fh.Ja = !0, fh.Ia = "cljs.core.async.impl.ioc-helpers/t24733", fh.Oa = function(b, d) {
    return D(d, "cljs.core.async.impl.ioc-helpers/t24733");
  });
  return new fh(b, gh, new s(null, 5, [ig, 19, Fg, 30, tg, 3, xg, 27, hg, "/home/miguel/tic-tac-toe/tic-tac-toe-cljs/target/cljsbuild-compiler-2/cljs/core/async/impl/ioc_helpers.cljs"], null));
};
function ih(a) {
  try {
...
function lh(a) {
  for (;;) {
    var b = a[4], c = og.d(b), d = Ag.d(b), e = a[5];
    if (t(function() {
      var a = e;
      return t(a) ? xa(b) : a;
    }())) {
...
ph.prototype.resize = function() {
  ...
  return this.w < this.head ? (oh(this.f, this.w, a, 0, this.length), this.w = 0, this.head = this.length, this.f = a) : this.w > this.head ? (oh(this.f, this.w, a, 0, this.f.length - this.w), oh(this.f, 0, a, this.f.length - this.w, this.head), this.w = 0, this.head = this.length, this.f = a) : this.w === this.head ? (this.head = this.w = 0, this.f = a) : null;
};
function rh(a, b) {
...
th.prototype.sb = function() {
  return this.F.pop();
};
th.prototype.ac = function(a, b) {
  qh(this.F, b);
  return this;
};
function vh(a) {
  return new th(sh(a), a);
}
;var wh = function() {
  function a(a, d) {
    var e = null;
...
xh(React.DOM.input, "input");
xh(React.DOM.textarea, "textarea");
xh(React.DOM.option, "option");
var yh = sh(32), zh = !1, Ah = !1;
function Bh() {
  zh = !0;
  Ah = !1;
  for (var a = 0;;) {
  ...
  zh = !1;
  return 0 < yh.length ? Ch.q ? Ch.q() : Ch.call(null) : null;
}
function Ch() {
  var a = Ah;
  if (t(t(a) ? zh : a)) {
  ...
  Ah = !0;
  "function" == q(aa.setImmediate) ? aa.setImmediate(Bh) : (mh || (mh = nh()), mh(Bh));
}
function Dh(a) {
  qh(yh, a);
  Ch();
}
;var Eh, Gh = function Fh(b) {
  "undefined" === typeof Eh && (Eh = function(b, d, e) {
    ...
    this.t = 0;
    this.k = 425984;
  }, Eh.prototype.ra = function() {
    return this.Q;
  }, Eh.prototype.C = function() {
    return this.Yc;
  }, Eh.prototype.G = function(b, d) {
    return new Eh(this.Q, this.tc, d);
  }, Eh.Ja = !0, Eh.Ia = "cljs.core.async.impl.channels/t24850", Eh.Oa = function(b, d) {
    return D(d, "cljs.core.async.impl.channels/t24850");
  });
  return new Eh(b, Fh, new s(null, 5, [ig, 22, Fg, 18, tg, 3, xg, 17, hg, "/home/miguel/tic-tac-toe/tic-tac-toe-cljs/target/cljsbuild-compiler-2/cljs/core/async/impl/channels.cljs"], null));
};
function Hh(a, b) {
  this.lb = a;
  this.Q = b;
...
Kh.prototype.Mc = function(a) {
  ...
  if (t(c)) {
    return a = ch(c.lb), Dh(function(a) {
      return function() {
        return a.d ? a.d(!0) : a.call(null, !0);
      };
    }(a, c, this)), Gh(c.Q);
  ...
  if (t(b.closed)) {
    ...
    }(), a = t(a) ? b.F.sb() : null, Gh(a)) : null;
  }
  64 < b.vb ? (b.vb = 0, rh(b.Va, bh)) : b.vb += 1;
  if (!(1024 > b.Va.length)) {
...
Kh.prototype.Ib = function(a, b, c) {
  var d = this;
  if (null == b) {
  ...
  if (t(e)) {
    return c = ch(e), Dh(function(a) {
      return function() {
        return a.d ? a.d(b) : a.call(null, b);
      };
    }(c, e, a, this)), Gh(!0);
  }
  64 < d.ub ? (d.ub = 0, rh(d.Ta, Ih)) : d.ub += 1;
  if (!(1024 > d.Ta.length)) {
...
function Mh(a, b, c) {
  b = (t(b) ? b : Lh).call(null, c);
  return null == b ? a : eh.c(a, b);
}
var Nh = function() {
  function a(a, b, c) {
    return new Kh(sh(32), 0, sh(32), 0, a, !1, function() {
      return function(a) {
        return function() {
          function b(d, e) {
            try {
      ...
      }(t(b) ? b.d ? b.d(eh) : b.call(null, eh) : eh);
    }());
  }
  function b(a, b) {
    return d.e(a, b, null);
...
var Oh = JSON.stringify(If(new s(null, 1, [kg, "StartGame"], null)));
var Z = function(a) {
  return function() {
    function b(b) {
...
Ph.Pc = function() {
  return Ph.dc ? Ph.dc : Ph.dc = new Ph;
};
Ph.prototype.$c = 0;
function Qh() {
...
var Xh = function Wh(b) {
  "undefined" === typeof Zg && (Zg = function(b, d, e) {
    ...
    return!0;
  }, Zg.prototype.cc = function() {
    return this.la;
  }, Zg.prototype.C = function() {
    return this.Wc;
  }, Zg.prototype.G = function(b, d) {
    return new Zg(this.la, this.Jb, d);
  }, Zg.Ja = !0, Zg.Ia = "cljs.core.async/t21327", Zg.Oa = function(b, d) {
    return D(d, "cljs.core.async/t21327");
  });
  return new Zg(b, Wh, new s(null, 5, [ig, 20, Fg, 16, tg, 3, xg, 13, hg, "/home/miguel/tic-tac-toe/tic-tac-toe-cljs/target/cljsbuild-compiler-2/cljs/core/async.cljs"], null));
}, Yh = function() {
  function a(a, b, c) {
    a = dc.c(a, 0) ? null : a;
    if (t(b) && !t(a)) {
    ...
    return Nh.e("number" === typeof a ? vh(a) : a, b, c);
  }
  function b(a, b) {
    return e.e(a, b, null);
  }
  ...
  function a(a, b, c, d) {
    a = $g(a, b, Xh(c));
    return t(a) ? (b = P.d ? P.d(a) : P.call(null, a), t(d) ? c.d ? c.d(b) : c.call(null, b) : Dh(function(a) {
      return function() {
...
var $ = !1, bi = null, ci = null, di = null, ei = {};
function fi(a) {
  if (a ? a.ed : a) {
    return a.ed(a);
  }
  var b;
  b = fi[q(null == a ? null : a)];
  if (!b && (b = fi._, !b)) {
...
Ni._ = function(a, b, c, d) {
  return Oi.e ? Oi.e(b, c, d) : Oi.call(null, b, c, d);
};
function Pi(a) {
  return Ji(a);
}
...
function Vi(a, b, c, d, e) {
  var f = P.d ? P.d(a) : P.call(null, a), g = Xd.c(Pi.d ? Pi.d(b) : Pi.call(null, b), c);
  c = (a ? t(t(null) ? null : a.Nd) || (a.T ? 0 : w(Ai, a)) : w(Ai, a)) ? Bi(a, b, c, d, e) : Hc(g) ? Pd.c(a, d) : Pd.n(a, ce, g, d);
  if (dc.c(c, Vg)) {
    return null;
  }
  a = new s(null, 5, [Qf, g, jg, $d.c(f, g), Sf, $d.c(P.d ? P.d(a) : P.call(null, a), g), Pf, f, Wf, P.d ? P.d(a) : P.call(null, a)], null);
  return null != e ? (e = U.e(a, Lg, e), Wi.c ? Wi.c(b, e) : Wi.call(null, b, e)) : Wi.c ? Wi.c(b, a) : Wi.call(null, b, a);
}
function Xi(a) {
  return a ? t(t(null) ? null : a.Kb) ? !0 : a.T ? !1 : w(Ii, a) : w(Ii, a);
}
function Yi(a) {
...
var cj = function() {
  ...
  c.c = a;
  return c;
}(), dj = Ac([Uf, rg, sg, ug, wg, yg, zg, Ig, Og, Sg], [function(a) {
  var b = Yi(this);
  if (b ? t(t(null) ? null : b.Id) || (b.T ? 0 : w(si, b)) : w(si, b)) {
    var c = this.state, d = $;
    try {
      $ = !0;
      var e = c.__om_prev_state;
      ti(b, Zi({props:a}), t(e) ? e : c.__om_state);
    } finally {
      $ = d;
    }
  }
  ...
  var a = Yi(this);
  if (a ? t(t(null) ? null : a.Vd) || (a.T ? 0 : w(oi, a)) : w(oi, a)) {
    var b = $;
    try {
      return $ = !0, pi(a);
    } finally {
  ...
  var b = Yi(this);
  if (b ? t(t(null) ? null : b.Ud) || (b.T ? 0 : w(ui, b)) : w(ui, b)) {
    var c = $;
    try {
      return $ = !0, vi(b, Zi({props:a}));
    } finally {
      $ = c;
    }
  } else {
  ...
  try {
    $ = !0;
    var c = this.props, d = this.state, e = Yi(this);
    cj.c(this, a);
    if (e ? t(t(null) ? null : e.Sd) || (e.T ? 0 : w(ii, e)) : w(ii, e)) {
      return ji(e, Zi({props:a}), Ci.d(this));
    }
    var f = c.__om_cursor, g = a.__om_cursor;
    return Cd.c(Hi(f), Hi(g)) ? !0 : Xi(f) && Xi(g) && Cd.c(Ji(f), Ji(g)) ? !0 : null != d.__om_pending_state ? !0 : c.__om_index !== a.__om_index ? !0 : !1;
  } finally {
    $ = b;
  }
}, function() {
  var a = Yi(this), b = this.props, c = $;
  try {
    if ($ = !0, a ? t(t(null) ? null : a.Lb) || (a.T ? 0 : w(wi, a)) : w(wi, a)) {
      var d = bi, e = di, f = ci;
      try {
        return bi = this, di = b.__om_app_state, ci = b.__om_instrument, xi(a);
      } finally {
        ci = f, di = e, bi = d;
      }
    } else {
      if (a ? t(t(null) ? null : a.zb) || (a.T ? 0 : w(yi, a)) : w(yi, a)) {
        d = bi;
        e = di;
        f = ci;
        try {
          return bi = this, di = b.__om_app_state, ci = b.__om_instrument, zi(a, $i.d(this));
        } finally {
          ci = f, di = e, bi = d;
        }
      } else {
  ...
  var b = Yi(this);
  if (b ? t(t(null) ? null : b.Wd) || (b.T ? 0 : w(qi, b)) : w(qi, b)) {
    var c = $;
    try {
      $ = !0, ri(b, Zi({props:a}), Ci.d(this));
    } finally {
      $ = c;
    }
  }
  ...
  var a = Yi(this), b = this.props, c = function() {
    var a = b.__om_init_state;
    return t(a) ? a : Je;
  }(), d = ag.d(c), c = {__om_state:mf.h(O([(a ? t(t(null) ? null : a.Md) || (a.T ? 0 : w(gi, a)) : w(gi, a)) ? function() {
    var b = $;
    try {
      return $ = !0, hi(a);
    } finally {
  ...
  }() : null, Bc.c(c, ag)], 0)), __om_id:t(d) ? d : ":" + (Ph.Pc().$c++).toString(36)};
  b.__om_init_state = null;
  return c;
}, function() {
  var a = Yi(this);
  if (a ? t(t(null) ? null : a.Hd) || (a.T ? 0 : w(mi, a)) : w(mi, a)) {
    var b = $;
    try {
      return $ = !0, ni(a);
    } finally {
  ...
  var a = Yi(this);
  if (a ? t(t(null) ? null : a.Jd) || (a.T ? 0 : w(ei, a)) : w(ei, a)) {
    var b = $;
    try {
      return $ = !0, fi(a);
    } finally {
  ...
  cj.d(this);
  var a = Yi(this);
  if (a ? t(t(null) ? null : a.md) || (a.T ? 0 : w(ki, a)) : w(ki, a)) {
    var b = $;
    try {
      $ = !0, li(a);
    } finally {
  ...
  a.Rd = function() {
    return function(a, c, d, e) {
      ...
      try {
        $ = !0;
        var f = this.props, g = this.state, k = Ci.d(this), l = f.__om_app_state;
        g.__om_pending_state = be(k, c, d);
        c = null != l;
        return t(c ? e : c) ? Fi(l, this) : null;
      } finally {
        $ = a;
      }
    };
...
h.v = function(a, b, c) {
  if ($) {
    return a = C.e(this.value, b, c), dc.c(a, c) ? c : Ni(this, a, this.state, vc.c(this.path, b));
  }
...
h.K = function(a, b) {
  if ($) {
    return Xi(b) ? dc.c(this.value, Hi(b)) : dc.c(this.value, b);
  }
  throw Error([z("Cannot manipulate cursor outside of render phase, only "), z("om.core/transact!, om.core/update!, and cljs.core/deref operations allowed")].join(""));
};
h.pc = function() {
...
h.R = function() {
  if ($) {
    return new fj(wc(this.value), this.state, this.path);
  }
  throw Error([z("Cannot manipulate cursor outside of render phase, only "), z("om.core/transact!, om.core/update!, and cljs.core/deref operations allowed")].join(""));
};
h.rb = function(a, b) {
  if ($) {
    return new fj(ab(this.value, b), this.state, this.path);
  }
  throw Error([z("Cannot manipulate cursor outside of render phase, only "), z("om.core/transact!, om.core/update!, and cljs.core/deref operations allowed")].join(""));
};
h.oc = !0;
h.Bb = function(a, b, c, d) {
  return Vi(this.state, this, b, c, d);
};
h.eb = function(a, b) {
  if ($) {
...
h.Ua = function(a, b, c) {
  if ($) {
    return new fj(Za(this.value, b, c), this.state, this.path);
  }
  throw Error([z("Cannot manipulate cursor outside of render phase, only "), z("om.core/transact!, om.core/update!, and cljs.core/deref operations allowed")].join(""));
};
h.O = function() {
  ...
  if ($) {
    return 0 < R(a.value) ? Rd.c(function(b) {
      return function(c) {
        var d = zc.e(c, 0, null);
        c = zc.e(c, 1, null);
        return new Y(null, 2, 5, te, [d, Ni(b, c, a.state, vc.c(a.path, d))], null);
      };
    }(this), a.value) : null;
  }
  throw Error([z("Cannot manipulate cursor outside of render phase, only "), z("om.core/transact!, om.core/update!, and cljs.core/deref operations allowed")].join(""));
...
h.G = function(a, b) {
  if ($) {
    return new fj(Ec(this.value, b), this.state, this.path);
  }
  throw Error([z("Cannot manipulate cursor outside of render phase, only "), z("om.core/transact!, om.core/update!, and cljs.core/deref operations allowed")].join(""));
};
h.P = function(a, b) {
  if ($) {
    return new fj(Ra(this.value, b), this.state, this.path);
  }
  throw Error([z("Cannot manipulate cursor outside of render phase, only "), z("om.core/transact!, om.core/update!, and cljs.core/deref operations allowed")].join(""));
};
h.call = function() {
...
h.M = function(a, b) {
  if ($) {
    return Ni(this, A.c(this.value, b), this.state, vc.c(this.path, b));
  }
  throw Error([z("Cannot manipulate cursor outside of render phase, only "), z("om.core/transact!, om.core/update!, and cljs.core/deref operations allowed")].join(""));
};
h.ba = function(a, b, c) {
  if ($) {
    return b < Oa(this.value) ? Ni(this, A.c(this.value, b), this.state, vc.c(this.path, b)) : c;
  }
  throw Error([z("Cannot manipulate cursor outside of render phase, only "), z("om.core/transact!, om.core/update!, and cljs.core/deref operations allowed")].join(""));
};
h.I = function(a, b, c) {
...
h.R = function() {
  if ($) {
    return new gj(wc(this.value), this.state, this.path);
  }
  throw Error([z("Cannot manipulate cursor outside of render phase, only "), z("om.core/transact!, om.core/update!, and cljs.core/deref operations allowed")].join(""));
};
h.oc = !0;
...
h.Ua = function(a, b, c) {
  if ($) {
    return Ni(this, ib(this.value, b, c), this.state, this.path);
  }
  throw Error([z("Cannot manipulate cursor outside of render phase, only "), z("om.core/transact!, om.core/update!, and cljs.core/deref operations allowed")].join(""));
};
h.O = function() {
  ...
  if ($) {
    return 0 < R(a.value) ? Rd.e(function(b) {
      return function(c, d) {
        return Ni(b, c, a.state, vc.c(a.path, d));
      };
...
h.G = function(a, b) {
  if ($) {
    return new gj(Ec(this.value, b), this.state, this.path);
  }
  throw Error([z("Cannot manipulate cursor outside of render phase, only "), z("om.core/transact!, om.core/update!, and cljs.core/deref operations allowed")].join(""));
};
h.P = function(a, b) {
  if ($) {
    return new gj(Ra(this.value, b), this.state, this.path);
  }
  throw Error([z("Cannot manipulate cursor outside of render phase, only "), z("om.core/transact!, om.core/update!, and cljs.core/deref operations allowed")].join(""));
};
h.call = function() {
...
function hj(a, b, c) {
  ...
  d.K = function() {
    return function(b, c) {
      if ($) {
        return Xi(c) ? dc.c(a, Hi(c)) : dc.c(a, c);
      }
      throw Error([z("Cannot manipulate cursor outside of render phase, only "), z("om.core/transact!, om.core/update!, and cljs.core/deref operations allowed")].join(""));
    };
  }(d);
...
var Oi = function() {
  function a(a, b, c) {
    return Xi(a) ? a : (a ? t(t(null) ? null : a.Td) || (a.T ? 0 : w(Li, a)) : w(Li, a)) ? Mi.e(a, b, c) : qc(a) ? new gj(a, b, c) : Lc(a) ? new fj(a, b, c) : (a ? a.t & 8192 || a.wd || (a.t ? 0 : w(Ka, a)) : w(Ka, a)) ? hj(a, b, c) : a;
  }
  function b(a, b) {
    return d.e(a, b, uc);
  }
...
function Wi(a, b) {
  var c = Ki(a);
  return Ui(c, b, Oi.c(P.d ? P.d(c) : P.call(null, c), c));
}
var ij = !1, jj = Ld.d ? Ld.d(pf) : Ld.call(null, pf);
function kj() {
  ij = !1;
  for (var a = F(P.d ? P.d(jj) : P.call(null, jj)), b = null, c = 0, d = 0;;) {
    if (d < c) {
      var e = b.M(null, d);
      e.q ? e.q() : e.call(null);
      d += 1;
...
var lj = Ld.d ? Ld.d(Je) : Ld.call(null, Je);
function mj(a, b) {
  var c = a ? t(t(null) ? null : a.Lb) ? !0 : a.T ? !1 : w(wi, a) : w(wi, a);
  if (!(c ? c : a ? t(t(null) ? null : a.zb) || (a.T ? 0 : w(yi, a)) : w(yi, a))) {
...
var nj = function() {
  function a(a, b) {
    null == a.om$descriptor && (a.om$descriptor = React.createClass(t(b) ? b : ej));
  ...
  function a(a, b, c) {
    ...
    if (null == c) {
      var g = aj.d(bi), k = nj.d(a), g = {children:function() {
        return function(c) {
          var f = $;
          try {
            $ = !0;
      ...
      }(g, k), __om_instrument:ci, __om_app_state:di, __om_shared:g, __om_cursor:b};
    ...
    var l = Sc(c) ? V.c(Jd, c) : c, m = S.c(l, Bg), n = S.c(l, ng), p = S.c(l, qg), r = S.c(l, cg), u = S.c(c, Vf), v = null != u ? function() {
      ...
      var a = Gg.d(c);
      return t(a) ? a : aj.d(bi);
    }(), k = nj.c(a, Tf.d(c)), g = {__om_shared:g, __om_index:Eg.d(c), __om_cursor:v, __om_app_state:di, key:y, __om_init_state:n, children:null == m ? function(b, c, e, f, g, k, l, m) {
      return function(b) {
        var c = $;
        try {
          $ = !0;
    ...
    }(c, l, m, n, p, r, u, v, y, g, k), __om_instrument:ci, __om_state:p};
    return k.d ? k.d(g) : k.call(null, g);
  }
  function b(a, b) {
    return c.e(a, b, null);
  ...
  function a(a, b, c) {
    if (null != ci) {
      ...
      a: {
        ...
        try {
          $ = !0;
          g = ci.e ? ci.e(a, b, c) : ci.call(null, a, b, c);
          break a;
        } finally {
          $ = k;
        }
...
function qj(a, b, c) {
  if (!(a ? t(t(null) ? null : a.gd) || (a.T ? 0 : w(Ri, a)) : w(Ri, a))) {
...
function uj(a) {
  var b = dg.d(a), c = vg.d(a), b = dc.c(b, c) ? function() {
...
function Dj(a) {
  return t(S.c(a, fg)) ? [z("blocked-tile "), z(Cj(S.c(a, fg)))].join("") : t(S.c(a, Mg)) ? "blocked-tile" : "tile";
}
var Fj = function Ej(b, c, d) {
  "undefined" === typeof xj && (xj = function(b, c, d, k, l) {
    this.ca = b;
    this.Ma = c;
    this.Wa = d;
    this.rd = k;
    ...
    this.t = 0;
    this.k = 393216;
  }, xj.prototype.Lb = !0, xj.prototype.Mb = function() {
    var b = this, c = {onClick:function() {
      return function() {
        if (xa(Mg.d(function() {
          ...
          console.log(c);
          return $h.c(eg.d(b.ca), new s(null, 2, [Kg, Kg.d(function() {
            var c = b.Wa;
            return P.d ? P.d(c) : P.call(null, c);
          }()), Of, Of.d(function() {
            var c = b.Wa;
    ...
    }(Mg.d(b.ca), this), className:Dj(b.Wa)}, d = fg.d(b.Wa);
    return React.DOM.div(c, d);
  }, xj.prototype.C = function() {
    return this.Rc;
  }, xj.prototype.G = function(b, c) {
    return new xj(this.ca, this.Ma, this.Wa, this.rd, c);
  }, xj.Ja = !0, xj.Ia = "tic-tac-toe.ui/t15179", xj.Oa = function(b, c) {
    return D(c, "tic-tac-toe.ui/t15179");
  });
  return new xj(d, c, b, Ej, new s(null, 5, [ig, 112, Fg, 41, tg, 3, xg, 32, hg, "/home/miguel/tic-tac-toe/tic-tac-toe-cljs/src/tic_tac_toe/ui.cljs"], null));
}, Hj = function Gj(b, c, d) {
  "undefined" === typeof yj && (yj = function(b, c, d, k, l) {
    this.ca = b;
    this.Ma = c;
    this.rc = d;
    this.Qc = k;
    ...
    this.t = 0;
    this.k = 393216;
  }, yj.prototype.Lb = !0, yj.prototype.Mb = function() {
    var b = this;
    return V.e(wh, {className:"row"}, Yd.c(function() {
      return function(c) {
        return pj.e(Fj, c, new s(null, 1, [Bg, b.ca], null));
      };
    }(this), b.rc));
  }, yj.prototype.C = function() {
    return this.Sc;
  }, yj.prototype.G = function(b, c) {
    return new yj(this.ca, this.Ma, this.rc, this.Qc, c);
  }, yj.Ja = !0, yj.Ia = "tic-tac-toe.ui/t15196", yj.Oa = function(b, c) {
    return D(c, "tic-tac-toe.ui/t15196");
  });
  return new yj(d, c, b, Gj, new s(null, 5, [ig, 72, Fg, 49, tg, 3, xg, 45, hg, "/home/miguel/tic-tac-toe/tic-tac-toe-cljs/src/tic_tac_toe/ui.cljs"], null));
  ...
  "undefined" === typeof zj && (zj = function(b, c, d, k, l) {
    ...
    this.t = 0;
    this.k = 393216;
  }, zj.prototype.zb = !0, zj.prototype.Ab = function() {
    var b = this, c = this, d = {className:"centered"}, k = function() {
      var k = {}, m = function() {
        var m = {}, p = V.e(wh, {className:"board"}, Yd.c(function() {
          return function(c) {
            return pj.e(Hj, c, new s(null, 1, [Bg, b.ca], null));
          };
    ...
    return new zj(this.ca, this.Ma, this.$, this.sc, c);
  }, zj.Ja = !0, zj.Ia = "tic-tac-toe.ui/t15209", zj.Oa = function(b, c) {
    return D(c, "tic-tac-toe.ui/t15209");
  });
  return new zj(d, c, b, Ij, new s(null, 5, [ig, 78, Fg, 61, tg, 3, xg, 53, hg, "/home/miguel/tic-tac-toe/tic-tac-toe-cljs/src/tic_tac_toe/ui.cljs"], null));
};
function Kj(a, b) {
  var c = Yh.d(1);
  Dh(function(c) {
      ...
      var e = function() {
        return function(a) {
          ...
          return function(d) {
            var e = d[1];
            if (7 === e) {
              var f = d[2], n = S.c(f, Of), p = S.c(f, Kg), r = P.d ? P.d(a) : P.call(null, a), u = vg.d(r), v = JSON.stringify(If(new s(null, 2, [kg, "PlayAtPosition", Hg, new s(null, 2, [Kg, p, Of, n], null)], null))), y = [z(" move -\x3e "), z(v)].join(""), G = console.log(y), J = Yg.send(v), I = rj.c(a, function() {
                return function(a, b, c, d) {
                  return function(a) {
                    var b = Rg.d(a), e = Jg.d(a);
                    a = U.e(a, Jg, be(e, new Y(null, 3, 5, te, [c, d, fg], null), b));
                    return Sh(U.e(a, Xf, vg), !0);
                  };
            ...
            return 3 === e ? (I = d[2], kh(d, I)) : 2 === e ? jh(d, b) : 1 === e ? (d[2] = null, d[1] = 2, mg) : null;
          };
        }(c), c);
      }(), f = function() {
...
function Lj(a, b) {
  ...
  switch(d) {
    case "NoPlayersAvailable":
      return rj.c(a, Th);
    case "GameStarted":
      return rj.c(a, function(a, b) {
        return function(a) {
          var c = S.c(b, "youArePlayer"), d = S.c(b, "whoStarts");
          a = U.e(U.e(a, Rg, c), Xg, d);
          return dc.c(c, d) ? Sh(U.e(a, Xf, Tg), !1) : Sh(U.e(a, Xf, vg), !0);
        };
      }(d, c, d));
    ...
    case "GameWon":
      return rj.c(a, function(a, b) {
        return function(a) {
          ...
          return Sh(U.e(U.e(a, Xf, $f), dg, c), !0);
        };
      }(d, c, d));
    case "Draw":
      return rj.c(a, function() {
        return function(a) {
          return Sh(U.e(a, Xf, Qg), !0);
        };
      }(d, c, d));
...
var Oj = function Nj(b, c, d) {
  "undefined" === typeof Aj && (Aj = function(b, c, d, k, l) {
    ...
    this.t = 0;
    this.k = 393216;
  }, Aj.prototype.zb = !0, Aj.prototype.Ab = function() {
    ...
    return new Aj(this.ca, this.Ma, this.$, this.Nc, c);
  }, Aj.Ja = !0, Aj.Ia = "tic-tac-toe.ui/t15344", Aj.Oa = function(b, c) {
    return D(c, "tic-tac-toe.ui/t15344");
  });
  return new Aj(d, c, b, Nj, new s(null, 5, [ig, 33, Fg, 106, tg, 3, xg, 93, hg, "/home/miguel/tic-tac-toe/tic-tac-toe-cljs/src/tic_tac_toe/ui.cljs"], null));
}, Pj = Qh();
(function(a, b, c) {
  ...
  var l = P.d ? P.d(lj) : P.call(null, lj);
  Uc(l, k) && S.c(l, k).call(null);
  l = Ef.q();
  b = (b ? b.t & 16384 || b.ud || (b.t ? 0 : w(Lb, b)) : w(Lb, b)) ? b : Ld.d ? Ld.d(b) : Ld.call(null, b);
  var m = qj(b, l, g), n = Bc.h(d, Ng, O([Wg, Qf], 0)), p = function(b, c, d, e, f, g, k, l, m, n, p) {
    return function ca() {
      Pd.e(jj, Gc, ca);
      var b = P.d ? P.d(d) : P.call(null, d), b = null == m ? Oi.e(b, d, uc) : Oi.e($d.c(b, m), d, m), c;
      a: {
        var f = ci, g = di;
        try {
          ci = l;
  ...
  Cf(m, l, function(a, b, c, d, e) {
    return function() {
      Uc(P.d ? P.d(jj) : P.call(null, jj), e) || Pd.e(jj, vc, e);
      if (t(ij)) {
        return null;
      }
      ij = !0;
      return "undefined" !== typeof requestAnimationFrame ? requestAnimationFrame(kj) : setTimeout(kj, 16);
    };
  }(l, b, m, n, p, c, d, d, e, f, g, k));
  Pd.n(lj, U, k, function(a, b, c, d, e, f, g, k, l, m, n, p) {
    return function() {
      Bb(c, a);
      Ti(c, a);
      Pd.e(lj, Bc, p);
  ...
  "undefined" === typeof Bj && (Bj = function(b, c, d, k, l) {
    ...
    this.t = 0;
    this.k = 393216;
  }, Bj.prototype.md = !0, Bj.prototype.qc = function() {
    Kj(this.$, eg.d(this.ca));
    var b = Gd.c(Lj, this.$);
    Yg.onmessage = b;
    b = Gd.c(Mj, this.$);
    return Yg.onopen = b;
  }, Bj.prototype.zb = !0, Bj.prototype.Ab = function() {
    var b = new s(null, 1, [Bg, this.ca], null), c = React.DOM.h1(null, "Tic Tac Toe"), d = pj.e(Oj, this.$, b), b = pj.e(Jj, this.$, b);
    return React.DOM.div({className:"game"}, c, d, b);
  }, Bj.prototype.C = function() {
    return this.Vc;
  }, Bj.prototype.G = function(b, c) {
    return new Bj(this.ca, this.Ma, this.$, this.Oc, c);
  }, Bj.Ja = !0, Bj.Ia = "tic-tac-toe.ui/t15366", Bj.Oa = function(b, c) {
    return D(c, "tic-tac-toe.ui/t15366");
  });
  return new Bj(d, c, b, Qj, new s(null, 5, [ig, 60, Fg, 122, tg, 3, xg, 110, hg, "/home/miguel/tic-tac-toe/tic-tac-toe-cljs/src/tic_tac_toe/ui.cljs"], null));
}, Ld.d ? Ld.d(Pj) : Ld.call(null, Pj), new s(null, 2, [Ng, document.getElementById("app"), Bg, new s(null, 1, [eg, Yh.q()], null)], null));
